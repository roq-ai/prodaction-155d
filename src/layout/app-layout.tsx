...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['super-admin', 'user', 'visitor', 'activated-user', 'not-activated-user'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Downloads', path: '/downloads', entity: 'download', service: AccessServiceEnum.PROJECT, icon: FiDownload },
    { name: 'Resources', path: '/resources', entity: 'resource', service: AccessServiceEnum.PROJECT, icon: FiDatabase },
